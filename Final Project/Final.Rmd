...
After understanding the impacts of the solar industry and through data seeing the limiations of it as well, I would hope to see these barriers broken in order to create an energy structure that is built and harvest, rather than mined and controlled, while also cleaning up our atmosphere slowly but importantly. 
